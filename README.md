...
It is possible to use sulfur ointment to treat acne, but it can also be used as an exfoliator since it sheds off dead skin cells. This type of exfoliation is not very common since it has a very nasty (smelly) side effect. If you can tolerate the smell, then this might be worth trying since it is highly effective against fungal acne as well as many other acne types. Another downside of this exfoliator is that is can be very drying, not very suitable for dry skin types. To use it, you simply put on a thin layer of ointment on cleaned skin on desired areas (can be used on body and face), but make sure you do not use high concentration ointment (10% is suitable for face and body, 30% should not be used on face), leave the ointment on for 10-30minutes and then wash it off. You should build tolerance gradually, start with using it a few times a week and move up to using it every day, if needed. Sulfur ointment should not be used together with other exfoliators since it can cause too much irritation.
...
**Sleeping:** When you sleep on your side, your skin gets pulled downwards due to gravity. Over time sleeping on your side might increase the appearance of wrinkles. Consider sleeping on your back, though snoring might be an issue for some people.
...
**Ultrasound therapy:** Research suggest that ultrasound therapy boosts significantly collagen production, which can make the skin appear more supple and smooth. Usually this procedure is done professionally, though some devices that can be used at home might give similar results, but will require many months of usage.
...
**Puffy eyes:** Many start noticing as we age puffy eyes, this can be due the same reasons as under-eye circles, very commonly this is due lack of hydration in your body, but very common it is due genetics. Your body starts to store more water if you do not get enough water, so drinking more water might be an easy fix along with proper rest and diet. Massaging your eye area with a jade roller or similar massager might give you some results by encouraging lymphatic drainage, though there is lack of evidence that jade rollers are efficient for achieving that. Some evidence exists that ultrasound therapy can reduce the appearance of puffy eyes (and undereye circles).
